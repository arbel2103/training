...
export interface Expense {
  ...
  /**
   * מתי בוצע השיוך (ISO) — לא מתי העסקה קרתה.
   * יתרה שהוזנה ידנית משקפת את מה שהיה ידוע באותו רגע, ולכן מה שקובע אם
   * ההוצאה כבר גלומה בה הוא זמן השיוך. שיוך של עסקה ישנה, שנעשה אחרי
   * עדכון היתרה, חייב לרדת ממנה.
   */
  savingsLinkedAt?: string
}
