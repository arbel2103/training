...
const STEPS: Step[] = [
  ...
  {
    icon: 'wallet',
    title: 'עוד אפליקציה: פיננסים',
    body: (
      <ul className="space-y-1 list-disc pr-4">
        <li>
          לחיצה על השם <b>TriLife</b> למעלה פותחת תפריט מעבר בין{' '}
          <b>TriLife</b> (טריאתלון ובריאות) ל<b>פיננסים</b> (הוצאות והון) — אותו
          עיצוב, אותו גיבוי לענן
        </li>
