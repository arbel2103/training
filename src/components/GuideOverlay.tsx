...
const STEPS: Step[] = [
  {
    ...
    body: (
      <>
        <p>
          זה מרכז האימונים והבריאות האישי שלך — מעקב אימונים, תוכנית מסודרת,
          תכנון מול היומן, מעקב בריאות, ומאמן AI אישי.
        </p>
  ...
  },
  {
    ...
    body: (
      <>
        <p>מסך הפתיחה — מבט מהיר על מה שחשוב היום:</p>
        <ul className="mt-2 space-y-1.5 list-disc pr-5">
          <li>ספירה לאחור לתחרות הקרובה 🏁</li>
          <li>
            האימונים המתוכננים להיום — עם כפתור <b>בצעתי ✓</b> בלחיצה אחת
          </li>
          <li>ההתקדמות השבועית (כמה אימונים כבר ביצעת), ומגמת המשקל</li>
          <li>תזכורת אם לא גיבית לענן לאחרונה</li>
        </ul>
      </>
    ),
    page: 0,
  },
  {
    ...
    body: (
      <>
        <p>
          כאן מזינים את מה שביצעת. תצוגה שבועית (ראשון–שבת) — לכל יום אפשר{' '}
          <b>+ הוסף אימון</b>: כוח, אירובי או אחר.
        </p>
        <ul className="mt-2 space-y-1.5 list-disc pr-5">
          <li>
            אימון שכבר מתוכנן מופיע עם <b>בצעתי ✓</b> — ממלא הכל מהתוכנית לבד
          </li>
          <li>
            <b>קצב:</b> פשוט מקלידים ספרות והנקודתיים נכנסות לבד — <code>530</code>{' '}
            הופך ל-<b>5:30</b>. המשך האימון מחושב אוטומטית
          </li>
          <li>
            טאב <b>היסטוריה</b> — כל האימונים + ניתוח לפי שבוע/חודש/טווח
          </li>
        </ul>
      </>
    ),
    ...
    body: (
      <>
        ...
        <ul className="mt-2 space-y-1.5 list-disc pr-5">
          ...
          <li>
            כל אימון שאתה מזין ב"מעקב" מסומן כאן <b>✓</b> אוטומטית — רואים מייד
  ...
  {
    icon: '🗓️',
    title: 'תכנון האימונים + היומן',
    body: (
      <>
        <p>
          לוח שבועי המחובר ל-<b>Google Calendar</b> שלך.
        </p>
        <ul className="mt-2 space-y-1.5 list-disc pr-5">
          <li>
            <b>התחברות ליומן:</b> לוחצים "התחבר", מאשרים עם חשבון Google. בתיבת
            הטקסט אפשר להזין <b>שם יומן או מילת מפתח</b> (למשל "אלבטרוס") כדי
            לטעון את היומן הנכון — וזה נשמר
          </li>
          <li>האירועים מהיומן מוצגים ברקע כדי לראות מתי פנוי</li>
          <li>
            מתכננים אימונים לימים, ובלחיצת <b>אשר</b> הם נכתבים ליומן האישי שלך
          </li>
        </ul>
      </>
    ),
  ...
  {
    icon: '⚖️',
    title: 'מעקב בריאות — משקל',
    body: (
      <>
        <p>
          עמוד <b>מעקב בריאות</b>, טאב <b>משקל</b>:
        </p>
        <ul className="mt-2 space-y-1.5 list-disc pr-5">
          <li>מזינים שקילה (משקל + תאריך)</li>
          <li>גרף מציג את מגמת המשקל לאורך זמן (ממוצע שבועי)</li>
        </ul>
      </>
    ),
    page: 4,
  ...
  {
    icon: '🩺',
    title: 'מעקב בריאות — בדיקות',
    body: (
      <>
        <p>
          טאב <b>בדיקות</b> — לעקוב אחרי בדיקות רפואיות ותוקפן:
        </p>
        <ul className="mt-2 space-y-1.5 list-disc pr-5">
          <li>סוג הבדיקה, תאריך ותוקף בחודשים — האפליקציה מחשבת מתי הבא</li>
          <li>אפשר להעלות את קובץ התוצאות ולפתוח אותו בכל עת</li>
        </ul>
      </>
    ),
    page: 4,
