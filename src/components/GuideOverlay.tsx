    ...
    body: (
      <>
        <p>
          ...
          טווח) עם ממוצעים ומרחקים לכל ספורט — ומתחתיו רשימת כל האימונים
          שאי-פעם הזנת.
        </p>
      </>
    ),
    ...
    body: (
      <>
        ...
        <ol className="mt-2 space-y-1.5 list-decimal pr-5">
          ...
          <li>
            כפתור <b>"שבץ את התוכנית לשבוע"</b> מושך את האימונים של המאמן ללוח —
            לכל אימון קובעים <b>שעה</b>
          </li>
          <li>
            <b>אשר ושלח ליומן</b> — הכל נכתב ליומן האישי שלך (מסומן "ביומן ✓")
          </li>
        </ol>
        <p className="mt-2 text-muted">אפשר גם להוסיף אימונים ידנית עם + הוסף.</p>
      </>
    ),
    page: 2,
  },
