  ...
  },
  {
    ...
    body: (
      <ul className="space-y-1 list-disc pr-4">
        ...
        <li>
          <b>חיבור חד-פעמי וחינמי:</b> בפתיחה הראשונה יופיע מדריך בן 3 שלבים
          ליצירת מפתח ב-Google AI Studio — בלי כרטיס אשראי. המפתח נשמר במכשיר
          שלך בלבד, ומפעיל גם את הערכת הארוחות ב<b>תזונה</b>
        </li>
      </ul>
    ),
    target: 'fab',
